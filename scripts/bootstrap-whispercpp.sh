...
SOURCE_PREFIX_MAP_FLAGS="-ffile-prefix-map=$ROOT_DIR=. -fmacro-prefix-map=$ROOT_DIR=."
...
cmake_args=(
  ...
  -DCMAKE_C_FLAGS="$SOURCE_PREFIX_MAP_FLAGS ${CMAKE_C_FLAGS:-}"
  -DCMAKE_CXX_FLAGS="$SOURCE_PREFIX_MAP_FLAGS ${CMAKE_CXX_FLAGS:-}"
  -DGGML_METAL=ON
